...
function getAnkyverseQuestion(wink) {
  const questionCycle = [
    ...
    "how does this chart make you feel? dive into it. spit it all out. blood is medicine. only if you allow it to be.",
    ...
    "Recall the last time that you felt an intense emotion. What was it? What did it bring to you? How do you make sense of it?",
    ...
    "how do you feel when someone cares about your work?",
